...
namespace GeocodeAPIPoC.Application.Extensions;

public static partial class GeocodeExtensions
{
    /// <summary>
    ...
    public static string ToKey(this string address) 
    {
        ...
        return MyRegex().Replace(address.Trim().ToLowerInvariant(), string.Empty)
